...
export const Card3H: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 2, cardImg: Card3HSvg };
export const Card4H: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 3, cardImg: Card4HSvg };
export const Card5H: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 4, cardImg: Card5HSvg };
export const Card6H: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 5, cardImg: Card6HSvg };
export const Card7H: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 6, cardImg: Card7HSvg };
export const Card8H: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 7, cardImg: Card8HSvg };
export const Card9H: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 8, cardImg: Card9HSvg };
export const CardTH: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 9, cardImg: CardTHSvg };
export const CardJH: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 10, cardImg: CardJHSvg };
...
export const Card3S: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 2, cardImg: Card3SSvg };
export const Card4S: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 3, cardImg: Card4SSvg };
export const Card5S: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 4, cardImg: Card5SSvg };
export const Card6S: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 5, cardImg: Card6SSvg };
export const Card7S: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 6, cardImg: Card7SSvg };
export const Card8S: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 7, cardImg: Card8SSvg };
export const Card9S: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 8, cardImg: Card9SSvg };
export const CardTS: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 9, cardImg: CardTSSvg };
export const CardJS: PlayingCardDescriptor = { suit: OSuit.Diamonds, rank: 10, cardImg: CardJSSvg };
