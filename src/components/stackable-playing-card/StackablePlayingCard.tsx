...
import { OPlayingCardStackMoveBehavior, type PlayingCardStackView } from '@/data/types';
...
export function StackablePlayingCard({ data, view, index, isPreviousSiblingBeingDragged, ...props }: PlayingCardProps) {
  ...
  const nextSiblingView = useMemo<PlayingCardStackView>(
    () => ({
      ...view,
      position: {
