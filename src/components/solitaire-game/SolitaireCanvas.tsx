    ...
    <div id="solitaire-cavas" ref={canvasRef} className="relative">
      {isCanvasAvailable && (
        <>
          ...
          {/* <StackablePlayingCardsStack id="tableau-pile-1" position={{ x: 20, y: LAYOUT_CONSTANTS.TABLEAU_STACKS_Y }} />
          <StackablePlayingCardsStack id="tableau-pile-2" position={{ x: 130, y: LAYOUT_CONSTANTS.TABLEAU_STACKS_Y }} />
          <StackablePlayingCardsStack id="tableau-pile-3" position={{ x: 240, y: LAYOUT_CONSTANTS.TABLEAU_STACKS_Y }} />
          <StackablePlayingCardsStack id="tableau-pile-4" position={{ x: 350, y: LAYOUT_CONSTANTS.TABLEAU_STACKS_Y }} />
          <StackablePlayingCardsStack id="tableau-pile-5" position={{ x: 460, y: LAYOUT_CONSTANTS.TABLEAU_STACKS_Y }} />
          <StackablePlayingCardsStack id="tableau-pile-6" position={{ x: 580, y: LAYOUT_CONSTANTS.TABLEAU_STACKS_Y }} />
          <StackablePlayingCardsStack id="tableau-pile-7" position={{ x: 700, y: LAYOUT_CONSTANTS.TABLEAU_STACKS_Y }} /> */}
        </>
      )}
    </div>
  );
